...
public class SendSmsServlet extends HttpServlet {
	...
	//这里请填写自己账户的信息
	private String appId = "103532";
	private String appSecret = " 2bb15935-7e58-49be-afa9-2b9b97f2cded";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			System.out.println(l+"===="+mobile+"==="+verifyCode);
			json.put("createTime",l);//创建时间  ！！！测试：暂时关闭判断时间
			// 将认证码存入SESSION
